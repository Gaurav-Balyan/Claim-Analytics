...
export class AdminComponent implements OnInit {
  ...
  showReportTest() {
    ...
    let embedUrl = this.powerBIDetails.EmbedUrl + this.powerBIDetails.Id + "&groupId=" + groupWorkspaceId;
